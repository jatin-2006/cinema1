...
<head>
    ...
    <title>Night-vision Cinema - Book Your Movie Experience</title>
...
<body class="min-h-screen" style="overflow: hidden;">
    ...
    <nav class="bg-gray-900 text-white py-4 px-6 shadow-lg">
        <div class="flex justify-between items-center max-w-7xl mx-auto">
            <div class="flex items-center space-x-2">
                ...
                <h1 class="text-2xl font-bold">Night-vision Cinema</h1>
            </div>
    ...
    <!-- Booking Modal -->
    <div id="bookingModal" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 modal opacity-100 pointer-events-auto">
        <div class="bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <img id="modalMoviePoster" src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/b292934c-c359-4d3b-8192-1efbd6b49e6a.png" alt="Galactic Odyssey movie poster" class="w-full rounded-lg">
                    </div>
                    
                    <div class="md:col-span-2">
                        <h4 id="modalMovieTitle" class="text-xl font-bold mb-2">Galactic Odyssey</h4>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap justify-center max-w-md mx-auto mt-4" id="seatsContainer"><div class="w-full flex justify-center mb-2"><div class="seat seat-available" id="A1">A1</div><div class="seat seat-available" id="A2">A2</div><div class="seat seat-available" id="A3">A3</div><div class="seat seat-available" id="A4">A4</div><div class="seat seat-available" id="A5">A5</div><div class="seat seat-available" id="A6">A6</div><div class="seat seat-available" id="A7">A7</div><div class="seat seat-available" id="A8">A8</div><div class="seat seat-available" id="A9">A9</div><div class="seat seat-available" id="A10">A10</div></div><div class="w-full flex justify-center mb-2"><div class="seat seat-available" id="B1">B1</div><div class="seat seat-available" id="B2">B2</div><div class="seat seat-available" id="B3">B3</div><div class="seat seat-available" id="B4">B4</div><div class="seat seat-available" id="B5">B5</div><div class="seat seat-available" id="B6">B6</div><div class="seat seat-available" id="B7">B7</div><div class="seat seat-available" id="B8">B8</div><div class="seat seat-available" id="B9">B9</div><div class="seat seat-available" id="B10">B10</div></div><div class="w-full flex justify-center mb-2"><div class="seat seat-available" id="C1">C1</div><div class="seat seat-available" id="C2">C2</div><div class="seat seat-available" id="C3">C3</div><div class="seat seat-available" id="C4">C4</div><div class="seat seat-available" id="C5">C5</div><div class="seat seat-available" id="C6">C6</div><div class="seat seat-available" id="C7">C7</div><div class="seat seat-available" id="C8">C8</div><div class="seat seat-available" id="C9">C9</div><div class="seat seat-available" id="C10">C10</div></div><div class="w-full flex justify-center mb-2"><div class="seat seat-available" id="D1">D1</div><div class="seat seat-available" id="D2">D2</div><div class="seat seat-available" id="D3">D3</div><div class="seat seat-available" id="D4">D4</div><div class="seat seat-available" id="D5">D5</div><div class="seat seat-available" id="D6">D6</div><div class="seat seat-available" id="D7">D7</div><div class="seat seat-available" id="D8">D8</div><div class="seat seat-available" id="D9">D9</div><div class="seat seat-available" id="D10">D10</div></div><div class="w-full flex justify-center mb-2"><div class="seat seat-available" id="E1">E1</div><div class="seat seat-available" id="E2">E2</div><div class="seat seat-available" id="E3">E3</div><div class="seat seat-available" id="E4">E4</div><div class="seat seat-available" id="E5">E5</div><div class="seat seat-available" id="E6">E6</div><div class="seat seat-available" id="E7">E7</div><div class="seat seat-available" id="E8">E8</div><div class="seat seat-available" id="E9">E9</div><div class="seat seat-available" id="E10">E10</div></div></div>
